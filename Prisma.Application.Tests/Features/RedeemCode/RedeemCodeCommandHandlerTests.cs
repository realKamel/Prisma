...
public class RedeemCodeCommandHandlerTests
{
    ...
    private readonly IRepository<GeneratedCode, int> _generatedCodeRepo = Substitute.For<IRepository<GeneratedCode, int>>();
