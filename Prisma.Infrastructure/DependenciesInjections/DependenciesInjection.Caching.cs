    ...
    )
    {
        ...
        services
            ...
            .WithDefaultEntryOptions(options =>
            {
                ...
                // A. Fail-Safe: If DB crashes under load, we serve stale data
                ...
                // B. Soft Timeout: If DB takes longer than 300ms during a rush,
                // abort waiting and instantly entry from the cached payload.
                options.FactorySoftTimeout = TimeSpan.FromMilliseconds(300);
