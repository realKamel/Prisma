...
internal sealed class GeneratedCodeConfiguration : IEntityTypeConfiguration<GeneratedCode>
{
    public void Configure(EntityTypeBuilder<GeneratedCode> builder)
    {
        ...
        builder.HasIndex(x => new { x.BatchId, x.Code }).IsUnique();

        builder
            .HasOne(x => x.RedeemedByStudent)
            .WithMany()
