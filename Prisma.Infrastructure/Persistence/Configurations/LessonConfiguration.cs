...
internal sealed class LessonConfiguration : IEntityTypeConfiguration<Lesson>
{
    public void Configure(EntityTypeBuilder<Lesson> builder)
    {
        ...
        builder.HasOne(l => l.Quiz).WithOne(l => l.Lesson).HasForeignKey<Quiz>(q => q.LessonId);

        builder.HasOne(l => l.Teacher).WithMany(t => t.Lessons).HasForeignKey(l => l.TeacherId);
